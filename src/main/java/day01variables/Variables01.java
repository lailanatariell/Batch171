...
//java bu satiri okumaz, Kendimize veya baskalarina aciklamadir .
        ...
        //Variable
        //Data type + Variable name + Atama operator(Assigmant operatoru) +Variable degeri + noktali virgul
        int             age                    =                            13               ;

        //java cumlesi => statement
        //Dilbilgisinde nokta ne ise javadaki ";" ayni seydir, yani statement'in bittigini gosterir
        //Eger variable declariaton yapar assigment yapmazsaniz java kendi default degerlerini koyar
        //Default deger sayılar icin sifirdir.
        //javada "=" assigment operator ve java bu operatoru gordugu zaman once sag tarafi calistirir.
        ...
        *
        ...
        //1
        int urununFiyati=90;
        float indirimFiyati = 89.99f;
        double sizinKariniz = 0.001;
        System.out.println(urununFiyati);
        System.out.println(indirimFiyati);
        System.out.println(sizinKariniz);
        //2
        String ulke="Kirgizistan ";
        String sehir="Talas ";
