...
public class StringManipulation02 {
    public static void main(String[] args) {
        ...
        //ornek: verilen iki string in birbirinin aynisi olup olmadigini kontrol eden kodu yaziniz
        ...
        //Stack-kucuk memory(char,boolean,byte,short,int,long,float,double)
        //Heap-buyuk memory(String, non-primitive, Wrapper, bizim olusturdugumuz class lar)
